...
framework::systems::imgui_render_system::imgui_render_system(
	const wrapper::directx12::swap_chain& swap_chain, 
	const render_device& device, uint32 font_size) :
	mSwapChain(swap_chain), mDevice(device.device())
{
...
void framework::systems::imgui_render_system::update(const runtime_service& service, const runtime_frame& delta)
{
	wrapper::directx12::extensions::imgui_context::new_frame();
}

void framework::systems::imgui_render_system::render(const runtime_service& service, const runtime_frame& delta)
{
...
ImTextureID framework::systems::imgui_render_system::allocate(const wrapper::directx12::texture2d& resource, size_t index) const
{
